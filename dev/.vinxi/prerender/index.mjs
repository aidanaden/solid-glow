...
import defu, {
  defuFn,
} from "file:///Users/aidan/Projects/solid-highlight/dev/node_modules/defu/dist/defu.mjs";
...
import {
  ...
  toNodeListener,
  toWebRequest,
} from "file:///Users/aidan/Projects/solid-highlight/dev/node_modules/h3/dist/index.mjs";
...
import "file:///Users/aidan/Projects/solid-highlight/dev/node_modules/node-fetch-native/dist/polyfill.cjs";
import {
  Headers as Headers$1,
  createFetch as createFetch$1,
} from "file:///Users/aidan/Projects/solid-highlight/dev/node_modules/ofetch/dist/node.mjs";
import { hash } from "file:///Users/aidan/Projects/solid-highlight/dev/node_modules/ohash/dist/index.mjs";
import {
  dirname,
  resolve,
} from "file:///Users/aidan/Projects/solid-highlight/dev/node_modules/pathe/dist/index.mjs";
import {
  createRouter,
  toRouteMatcher,
} from "file:///Users/aidan/Projects/solid-highlight/dev/node_modules/radix3/dist/index.mjs";
...
} from "file:///Users/aidan/Projects/solid-highlight/dev/node_modules/seroval-plugins/dist/esm/production/web.mjs";
import {
  crossSerializeStream,
  fromJSON,
  getCrossReferenceHeader,
} from "file:///Users/aidan/Projects/solid-highlight/dev/node_modules/seroval/dist/esm/production/index.mjs";
import {
  decodePath,
  getQuery,
  joinURL,
...
} from "file:///Users/aidan/Projects/solid-highlight/dev/node_modules/ufo/dist/index.mjs";
import {
  createCall,
  createFetch,
} from "file:///Users/aidan/Projects/solid-highlight/dev/node_modules/unenv/runtime/fetch/index.mjs";
import {
  createStorage,
  prefixStorage,
} from "file:///Users/aidan/Projects/solid-highlight/dev/node_modules/unstorage/dist/index.mjs";
...
import {
  ...
  lazy,
  sharedConfig,
} from "file:///Users/aidan/Projects/solid-highlight/node_modules/.pnpm/solid-js@1.8.9/node_modules/solid-js/dist/server.js";
import {
  NoHydration,
  createComponent,
  escape,
  ...
  ssrElement,
  ssrHydrationKey,
} from "file:///Users/aidan/Projects/solid-highlight/node_modules/.pnpm/solid-js@1.8.9/node_modules/solid-js/web/dist/server.js";
...
const serverAssets = [
  {
    baseName: "server",
    dir: "/Users/aidan/Projects/solid-highlight/dev/assets",
  },
];
...
storage.mount(
  ...
  unstorage_47drivers_47fs_45lite({
    driver: "fsLite",
    base: "/Users/aidan/Projects/solid-highlight/dev/.data/kv",
  }),
);
storage.mount(
  "root",
  unstorage_47drivers_47fs({
    driver: "fs",
    readOnly: true,
    base: "/Users/aidan/Projects/solid-highlight/dev",
...
storage.mount(
  ...
  unstorage_47drivers_47fs({
    driver: "fs",
    readOnly: false,
    base: "/Users/aidan/Projects/solid-highlight/dev/.vinxi",
    ignore: ["**/node_modules/**", "**/.git/**"],
  }),
);
storage.mount(
  ...
  unstorage_47drivers_47fs({
    driver: "fs",
    readOnly: false,
    base: "/Users/aidan/Projects/solid-highlight/dev/.vinxi/cache",
    ignore: ["**/node_modules/**", "**/.git/**"],
  }),
);
  ...
  routers: [
    {
      ...
      dir: "./public",
      base: "/",
      root: "/Users/aidan/Projects/solid-highlight/dev",
      order: 0,
      outDir: "/Users/aidan/Projects/solid-highlight/dev/.vinxi/build/public",
    },
    {
      name: "ssr",
      mode: "handler",
      ...
      root: "/Users/aidan/Projects/solid-highlight/dev",
      base: "/",
      outDir: "/Users/aidan/Projects/solid-highlight/dev/.vinxi/build/ssr",
      order: 1,
    },
    {
      name: "client",
      ...
      base: "/_build",
      root: "/Users/aidan/Projects/solid-highlight/dev",
      outDir: "/Users/aidan/Projects/solid-highlight/dev/.vinxi/build/client",
      order: 2,
    },
    {
      name: "server-fns",
      mode: "handler",
      base: "/_server",
      handler: "node_modules/@solidjs/start/config/server-handler.js",
      target: "server",
      root: "/Users/aidan/Projects/solid-highlight/dev",
      outDir:
        "/Users/aidan/Projects/solid-highlight/dev/.vinxi/build/server-fns",
      order: 3,
    },
  ],
  server: {
...
const buildManifest = {
  ...
  client: {
    "\u0000virtual:#vinxi/handler/client.css": {
      file: "assets/client-077a2b3c.css",
      src: "\u0000virtual:#vinxi/handler/client.css",
    },
    "virtual:#vinxi/handler/client": {
      css: ["assets/client-077a2b3c.css"],
      file: "assets/client-e2fe8486.js",
      isEntry: true,
...
const plugins = [plugin, _hEvg4IWjBS, _DH70YvFVQx, app];
...
const p = "Invariant Violation",
  {
    setPrototypeOf: z = function (e, t) {
...
class m extends Error {
  constructor(t = p) {
    super(
      typeof t == "number"
        ? `${p}: ${t} (see https://github.com/apollographql/invariant-packages)`
        : t,
    );
...
const x = Symbol("h3Event"),
  f$1 = Symbol("fetchEvent"),
  J = {
    get(e, t) {
      var _a;
...
function M(e) {
  return (
    e.web || (e.web = { url: getRequestURL(e), request: toWebRequest(e) }),
    new Proxy(
      {
        request: e.web.request,
        clientAddress: getRequestIP(e),
        locals: {},
        [x]: e,
      },
      J,
...
async function j(e) {
  ...
  const t = W(e),
    n = t.request,
    s = n.headers.get("x-server-id"),
    i = n.headers.get("x-server-instance"),
    o = new URL(n.url);
  let c, u;
  if (s)
    d(typeof s == "string", "Invalid server function"), ([c, u] = s.split("#"));
  else if (
    ((c = o.searchParams.get("id")), (u = o.searchParams.get("name")), !c || !u)
  )
  ...
  h.startsWith("multipart/form-data") ||
  h.startsWith("application/x-www-form-urlencoded")
    ? a.push(await n.formData())
    : (a = fromJSON(await n.json(), {
        plugins: [
          CustomEventPlugin,
          DOMExceptionPlugin,
          EventPlugin,
  ...
  try {
    const r = await provideRequestEvent(
      t,
      () => ((sharedConfig.context = { event: t }), O(...a)),
    );
    if (!i) {
      const l = r instanceof Error,
        T = new URL(n.headers.get("referer"));
          ...
          ...(r
            ? {
                "Set-Cookie": `flash=${JSON.stringify({
                  url: o.pathname + encodeURIComponent(o.search),
                  result: l ? r.message : r,
                  error: l,
                  input: [...a.slice(0, -1), [...a[a.length - 1].entries()]],
                })}; Secure; HttpOnly;`,
              }
            : {}),
        },
    ...
    return typeof r == "string"
      ? new Response(r)
      : (setHeader(e, "content-type", "text/javascript"), _(i, r));
  } catch (r) {
    return r instanceof Response && r.status === 302
      ? new Response(null, {
          status: i ? 204 : 302,
...
const C = [],
  D = G(C.filter((e) => e.type === "page")),
  K = Q(C.filter((e) => e.type === "api"));
function Y(e, s) {
  const t = e.split("/").filter(Boolean);
  e: for (const n of K) {
    const r = n.matchSegments;
    if (t.length < r.length || (!n.wildcard && t.length > r.length)) continue;
    for (let i = 0; i < r.length; i++) {
      const l = r[i];
      if (l && t[i] !== l) continue e;
    }
    const a = n[`$${s}`];
    if (a === "skip" || a === void 0) return;
    const o = {};
...
function G(e) {
  function s(t, n, r, a) {
    ...
    return o
      ? (s(o.children || (o.children = []), n, r.slice(o.id.length)), t)
      : (t.push({ ...n, id: r, path: r.replace(/\/\([^)/]+\)/g, "") }), t);
  }
  return e
    .sort((t, n) => t.path.length - n.path.length)
    .reduce((t, n) => s(t, n, n.path, n.path), []);
}
function Q(e) {
  return e
    .flatMap((s) => T(s.path).map((n) => ({ ...s, path: n })))
    .map(V)
    .sort((s, t) => t.score - s.score);
}
function T(e) {
  let s = /(\/?\:[^\/]+)\?/.exec(e);
  if (!s) return [e];
  let t = e.slice(0, s.index),
...
function V(e) {
  ...
  for (const [o, i] of s.entries())
    if (i[0] === ":") {
      ...
      i[0] === "*"
        ? ((r -= 1),
          t.push({ type: "*", name: i.slice(1), index: o }),
          (a = true))
        : ((r += 4), i.match(/^\(.+\)$/) || n.push(i));
  return { ...e, score: r, params: t, matchSegments: n, wildcard: a };
}
const E = Symbol("h3Event"),
  f = Symbol("fetchEvent"),
  X = {
    get(e, s) {
      var _a;
...
function se(e, s, t, n = "default") {
  return lazy(async () => {
    var _a;
    {
      const a = (await e.import())[n],
        i = (
          await ((_a = s.inputs) == null ? void 0 : _a[e.src].assets())
        ).filter((c) => c.tag === "style" || c.attrs.rel === "stylesheet");
      return {
        default: (c) => [...i.map((u) => A(u)), createComponent$1(a, c)],
      };
    }
  });
}
function re() {
  function e(t) {
    return {
      ...
      metadata: {
        ...(t.$$route ? t.$$route.require().route.metadata : {}),
        filesystem: true,
      },
      component: se(
        t.$component,
...
function oe(e) {
  ...
  return (
    setCookie(e, "flash", "", { maxAge: 0 }),
    { url: t.url, result: t.error ? new Error(t.result) : t.result, input: n }
  );
}
async function ae(e) {
  ...
  return (
    ...
    Object.assign(e, {
      ...
      assets: [...(await s.inputs[s.handler].assets())],
      initialSubmission: oe(e),
      routes: re(),
      components: {
        status: (n) => (
          setResponseStatus(e, n.code, n.text), () => setResponseStatus(e, 200)
        ),
        header: (n) => (
          n.append
            ? appendResponseHeader(e, n.name, n.value)
            : setResponseHeader(e, n.name, n.value),
          () => {
            ...
            if (r && typeof r == "string") {
              ...
              o !== -1 && a.splice(o, 1),
                a.length
                  ? setResponseHeader(e, n.name, a.join(", "))
                  : removeResponseHeader(e, n.name);
            }
          }
        ),
      },
...
function ie(e, s = {}) {
  return eventHandler({
    ...
    onBeforeResponse: s.onBeforeResponse,
    handler: (t) => {
      const n = ee(t);
      return provideRequestEvent(n, async () => {
        ...
        } else o.onCompleteAll = $(a);
        if (o.onCompleteShell) {
          const u = o.onCompleteShell;
          o.onCompleteShell = (m) => {
            v(a, t)(), u(m);
          };
        } else o.onCompleteShell = v(a, t);
        const i = renderToStream(
          () => ((sharedConfig.context.event = a), e(a)),
          o,
        );
...
function v(e, s) {
  return () => {
    e.response &&
      ...
      (setResponseStatus(s, 302),
      setHeader(s, "Location", e.response.headers.get("Location")));
  };
}
function $(e) {
  return ({ write: s }) => {
...
var le = ["<script", ">", "</script>"],
  ce = ["<script", ' type="module"', "></script>"];
          ...
          get scripts() {
            return [
              ssr(
                le,
                ssrHydrationKey(),
                `window.manifest = ${JSON.stringify(s.manifest)}`,
              ),
              ssr(
                ce,
                ssrHydrationKey(),
...
const Re = ie(() =>
  createComponent(me, {
    document: ({ assets: e, children: s, scripts: t }) =>
      ssr(
        de,
        ssrHydrationKey(),
